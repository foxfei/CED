...
public class WebApplicationRuntimeException extends RuntimeException {
	 ...
	 *            the detail message
	 */
	public WebApplicationRuntimeException(String msg) {
		super(msg);
	}
	 ...
	 */
	public WebApplicationRuntimeException(String msg, Throwable cause) {
		super(msg, cause);
	}
	...
	public WebApplicationRuntimeException(int errorCode, String msg) {
		super(msg);
		this.setErrorCode(errorCode);
	}

	public WebApplicationRuntimeException(int errorCode, String msg, Throwable cause) {
		super(msg, cause);
		this.setErrorCode(errorCode);
	}
