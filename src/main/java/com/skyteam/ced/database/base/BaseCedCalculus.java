...
/**
 * This is an object that contains data related to the ced_calculus table.
...
public abstract class BaseCedCalculus  implements Serializable {

	public static String REF = "CedCalculus";
	 ...
	 */
	public BaseCedCalculus (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.skyteam.ced.database.CedCalculus)) return false;
		else {
			com.skyteam.ced.database.CedCalculus cedCalculus = (com.skyteam.ced.database.CedCalculus) obj;
			if (null == this.getId() || null == cedCalculus.getId()) return false;
			else return (this.getId().equals(cedCalculus.getId()));
		}
	}
